...
1. Use GitHub Issues to document requirements (see [Chapter 20: Software development practices from *R Packages (2e)* by Hadley Wickham and Jennifer Bryan](https://r-pkgs.org/software-development-practices.html) and `usethis::use_github()`).

...
3. Link tests to issues by including `#{issue-number}` in the test description, such as:
...
3. **🧑‍🔬 Write Tests:** Quality Control Programmer writes needed tests and includes a link to the issue by including `(#{issue-number})` in the test description.

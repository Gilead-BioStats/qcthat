...
Before submitting a pull request, make sure to file an [issue](https://github.com/Gilead-Public/qcthat/issues), which should generally fall under one of the following categories:
...
Please note that the `{qcthat}` project is released with a [Contributor Code of Conduct](https://gilead-public.github.io/qcthat/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.

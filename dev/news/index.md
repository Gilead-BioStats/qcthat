...
This patch release streamlines and hones the GitHub Action installed via
[`Action_qcthat()`](https://gilead-public.github.io/qcthat/dev/reference/Action_qcthat.md).

### Action changes

- [`Action_qcthat()`](https://gilead-public.github.io/qcthat/dev/reference/Action_qcthat.md)
  now installs an action from a dedicated “actions” branch, allowing us
  to keep the action up-to-date with changes in GitHub policies without
  requiring an update to the package itself
  ([\#303](https://github.com/Gilead-Public/qcthat/issues/303),
  [\#205](https://github.com/Gilead-Public/qcthat/issues/205)).
- The `sessioninfo` runs are now displayed in the action runs and linked
  to from PR comments, rather than displaying in the comments
  themselves. This makes it easier to read comments generated by this
  package in email
  ([\#295](https://github.com/Gilead-Public/qcthat/issues/295)).
- The issue-test matrix underlying the full package report is attached
  to releases as JSON (via
  [`SaveAsJSON()`](https://gilead-public.github.io/qcthat/dev/reference/SaveAsJSON.md)),
  which can be read back into R with
  [`ReadJSONAsIssueTestMatrix()`](https://gilead-public.github.io/qcthat/dev/reference/ReadJSONAsIssueTestMatrix.md)
  ([\#298](https://github.com/Gilead-Public/qcthat/issues/298)).
- If the `fail-for-missing-tests` input is `true` (default), the qcthat
  action fails if any issues associated with the triggering PR lack
  tests (and are not tagged with `qcthat-nocov`)
  ([\#288](https://github.com/Gilead-Public/qcthat/issues/288)).
- [`TriggerUAT()`](https://gilead-public.github.io/qcthat/dev/reference/TriggerUAT.md)
  checks the status of PRs again before triggering re-runs of actions,
  to minimize instances were actions try to run an extra time if a PR is
  closed while
  [`TriggerUAT()`](https://gilead-public.github.io/qcthat/dev/reference/TriggerUAT.md)
  is processing
  ([\#299](https://github.com/Gilead-Public/qcthat/issues/299)).
- Actions triggered via workflow dispatch now set the branch properly
  ([\#308](https://github.com/Gilead-Public/qcthat/issues/308)), and
  action input names match a more standard style
  ([\#310](https://github.com/Gilead-Public/qcthat/issues/310)).

### Other changes

- [`ExpectUserAccepts()`](https://gilead-public.github.io/qcthat/dev/reference/ExpectUserAccepts.md)
  now automatically assigns UAT issues to GitHub usernames passed as
  `chrAssignees`, defaulting to the value of a `qcthat_UAT_ASSIGNEES`
  environment variable. This variable can be set in the GitHub action
  via the `uat-assignees` input, automatically triggering different UAT
  reviewers at different stages of development
  ([\#193](https://github.com/Gilead-Public/qcthat/issues/193)).
...
- [`vignette("expect_user_accepts")`](https://gilead-public.github.io/qcthat/dev/articles/expect_user_accepts.md)
  ...
  process ([\#293](https://github.com/Gilead-Public/qcthat/issues/293)).
...
- [`ExpectUserAccepts()`](https://gilead-public.github.io/qcthat/dev/reference/ExpectUserAccepts.md)
  ...
  ([\#290](https://github.com/Gilead-Public/qcthat/issues/290)).
...
- Two new vignettes have been added,
  ...
  and
  [`vignette("business_process")`](https://gilead-public.github.io/qcthat/dev/articles/business_process.md).
  They were split off and refined from information that was previously
  in the README
  ([\#98](https://github.com/Gilead-Public/qcthat/issues/98),
  [\#236](https://github.com/Gilead-Public/qcthat/issues/236)).
- The slide deck on the pkgdown site has been finalized ahead of PHUSE
  US Connect 2026
  ([\#170](https://github.com/Gilead-Public/qcthat/issues/170)).

### Bug fixes

- Warnings in tests now produce warnings rather than errors
  ([\#130](https://github.com/Gilead-Public/qcthat/issues/130)).
- Tests are no longer double-counted when they are associated with
  multiple issues
  ([\#180](https://github.com/Gilead-Public/qcthat/issues/180)).
...
[\#241](https://github.com/Gilead-Public/qcthat/issues/241).
...
- The experimental `tag-tests-with-issues` skill now generates a report
  ...
  ([\#242](https://github.com/Gilead-Public/qcthat/issues/242)).
...
- [`FetchRepoIssueClosers()`](https://gilead-public.github.io/qcthat/dev/reference/FetchRepoIssueClosers.md)
  ...
  optimized
  ([\#243](https://github.com/Gilead-Public/qcthat/issues/243),
  [\#251](https://github.com/Gilead-Public/qcthat/issues/251)).
- [`ExtractTestsFromFiles()`](https://gilead-public.github.io/qcthat/dev/reference/ExtractTestsFromFiles.md)
  ...
  ([\#247](https://github.com/Gilead-Public/qcthat/issues/247),
  [\#257](https://github.com/Gilead-Public/qcthat/issues/257)).
- [`GetGHRemote()`](https://gilead-public.github.io/qcthat/dev/reference/GetGHRemote.md)
  no longer truncates the repo name for repositories with a `.` in the
  name (such as “gsm.reporting”)
  ([\#248](https://github.com/Gilead-Public/qcthat/issues/248)).
- The `qcthat.yaml` workflow no longer erroneously mentions “push”
  triggers
  ([\#259](https://github.com/Gilead-Public/qcthat/issues/259)).
...
- [`ExpectUserAccepts()`](https://gilead-public.github.io/qcthat/dev/reference/ExpectUserAccepts.md)
  ...
  ([\#65](https://github.com/Gilead-Public/qcthat/issues/65),
  [\#111](https://github.com/Gilead-Public/qcthat/issues/111),
  [\#113](https://github.com/Gilead-Public/qcthat/issues/113),
  [\#115](https://github.com/Gilead-Public/qcthat/issues/115),
  [\#120](https://github.com/Gilead-Public/qcthat/issues/120)).
- [`TriggerUAT()`](https://gilead-public.github.io/qcthat/dev/reference/TriggerUAT.md)
  ...
  ([\#65](https://github.com/Gilead-Public/qcthat/issues/65),
  [\#111](https://github.com/Gilead-Public/qcthat/issues/111),
  [\#114](https://github.com/Gilead-Public/qcthat/issues/114),
  [\#115](https://github.com/Gilead-Public/qcthat/issues/115),
  [\#116](https://github.com/Gilead-Public/qcthat/issues/116),
  [\#157](https://github.com/Gilead-Public/qcthat/issues/157)).
...
- [`use_qcthat()`](https://gilead-public.github.io/qcthat/dev/reference/use_qcthat.md)
  ...
  ([\#129](https://github.com/Gilead-Public/qcthat/issues/129),
  [\#141](https://github.com/Gilead-Public/qcthat/issues/141),
  [\#143](https://github.com/Gilead-Public/qcthat/issues/143),
  [\#161](https://github.com/Gilead-Public/qcthat/issues/161),
  [\#165](https://github.com/Gilead-Public/qcthat/issues/165),
  [\#181](https://github.com/Gilead-Public/qcthat/issues/181),
  [\#198](https://github.com/Gilead-Public/qcthat/issues/198)).
- Experimental AI agent features:
  ...
  ([\#52](https://github.com/Gilead-Public/qcthat/issues/52),
  [\#53](https://github.com/Gilead-Public/qcthat/issues/53),
  [\#200](https://github.com/Gilead-Public/qcthat/issues/200),
  [\#201](https://github.com/Gilead-Public/qcthat/issues/201),
  [\#233](https://github.com/Gilead-Public/qcthat/issues/233)).

### Other changes

- Additional improvements to QC reports, such as links to the GitHub
  Actions run
  ([\#150](https://github.com/Gilead-Public/qcthat/issues/150)),
  timestamps
  ([\#172](https://github.com/Gilead-Public/qcthat/issues/172)), and
  attaching QC Reports to releases within the release description
  ([\#152](https://github.com/Gilead-Public/qcthat/issues/152)).
  Additional changes are tracked in the parent issues
  ([\#123](https://github.com/Gilead-Public/qcthat/issues/123),
  [\#160](https://github.com/Gilead-Public/qcthat/issues/160)).
- The `pkgdown` site for `qcthat` now includes a slide deck to introduce
  the package and the associated system
  ([\#166](https://github.com/Gilead-Public/qcthat/issues/166),
  [\#167](https://github.com/Gilead-Public/qcthat/issues/167),
  [\#168](https://github.com/Gilead-Public/qcthat/issues/168),
  [\#169](https://github.com/Gilead-Public/qcthat/issues/169)).

### Bug fixes

- Ignored issues are filtered out of reports
  ([\#118](https://github.com/Gilead-Public/qcthat/issues/118)).
- Reports work properly when the active branch is associated with
  multiple PRs
  ([\#132](https://github.com/Gilead-Public/qcthat/issues/132)), when
  the PRs contain a lot of commits
  ([\#133](https://github.com/Gilead-Public/qcthat/issues/133)), and
  after PRs are merged
  ([\#149](https://github.com/Gilead-Public/qcthat/issues/149)).
- [`GetGHOwner()`](https://gilead-public.github.io/qcthat/dev/reference/GetGHOwner.md)
  ...
  ([\#199](https://github.com/Gilead-Public/qcthat/issues/199)).
...
- [`QCPackage()`](https://gilead-public.github.io/qcthat/dev/reference/QCPackage.md)
  ...
  repository ([\#46](https://github.com/Gilead-Public/qcthat/issues/46),
  [\#69](https://github.com/Gilead-Public/qcthat/issues/69)).
- [`QCCompletedIssues()`](https://gilead-public.github.io/qcthat/dev/reference/QCCompletedIssues.md)
  ...
  ([\#69](https://github.com/Gilead-Public/qcthat/issues/69),
  [\#80](https://github.com/Gilead-Public/qcthat/issues/80)).
- [`QCIssues()`](https://gilead-public.github.io/qcthat/dev/reference/QCIssues.md)
  for specific issues
  ([\#86](https://github.com/Gilead-Public/qcthat/issues/86)), and
  ...
  ([\#68](https://github.com/Gilead-Public/qcthat/issues/68),
  [\#88](https://github.com/Gilead-Public/qcthat/issues/88))
- [`QCPR()`](https://gilead-public.github.io/qcthat/dev/reference/QCPR.md)
  ...
  ([\#68](https://github.com/Gilead-Public/qcthat/issues/68),
  [\#84](https://github.com/Gilead-Public/qcthat/issues/84)).
...
- `Action_QCCompletedIssues()` to run
  [`QCCompletedIssues()`](https://gilead-public.github.io/qcthat/dev/reference/QCCompletedIssues.md)
  ([\#69](https://github.com/Gilead-Public/qcthat/issues/69),
  [\#73](https://github.com/Gilead-Public/qcthat/issues/73)).
- `Action_QCPRIssues()` to run
  [`QCPR()`](https://gilead-public.github.io/qcthat/dev/reference/QCPR.md)
  for specific pull requests
  ([\#55](https://github.com/Gilead-Public/qcthat/issues/55),
  [\#68](https://github.com/Gilead-Public/qcthat/issues/68)).
...
- Function
  ...
  ([\#34](https://github.com/Gilead-Public/qcthat/issues/34),
  [\#47](https://github.com/Gilead-Public/qcthat/issues/47)).
- Function
  ...
  ([\#32](https://github.com/Gilead-Public/qcthat/issues/32)).
- Function
  ...
  ([\#35](https://github.com/Gilead-Public/qcthat/issues/35),
  [\#49](https://github.com/Gilead-Public/qcthat/issues/49)).
- Custom print methods for `qcthat_SingleIssueTestResults`,
  ...
  ([\#31](https://github.com/Gilead-Public/qcthat/issues/31),
  [\#36](https://github.com/Gilead-Public/qcthat/issues/36),
  [\#45](https://github.com/Gilead-Public/qcthat/issues/45),
  [\#60](https://github.com/Gilead-Public/qcthat/issues/60),
  [\#61](https://github.com/Gilead-Public/qcthat/issues/61)).

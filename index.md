...
Use
[`qcthat::FetchRepoIssues()`](https://gilead-biostats.github.io/qcthat/reference/FetchRepoIssues.md)
to get the issues for the repository connected to the active project,
and compile the test results with
[`qcthat::CompileTestResults()`](https://gilead-biostats.github.io/qcthat/reference/CompileTestResults.md).
Together these data frames are used by
[`qcthat::CompileIssueTestMatrix()`](https://gilead-biostats.github.io/qcthat/reference/CompileIssueTestMatrix.md)

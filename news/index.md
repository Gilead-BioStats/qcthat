...
- [`Action_qcthat()`](https://gilead-biostats.github.io/qcthat/reference/Action_qcthat.md)
  ...
  ([\#303](https://github.com/Gilead-BioStats/qcthat/issues/303),
  [\#205](https://github.com/Gilead-BioStats/qcthat/issues/205)).
- The `sessioninfo` runs are now displayed in the action runs and linked
  ...
  package in email
  ([\#295](https://github.com/Gilead-BioStats/qcthat/issues/295)).
- The issue-test matrix underlying the full package report is attached
  ...
  ([\#298](https://github.com/Gilead-BioStats/qcthat/issues/298)).
- If the `fail-for-missing-tests` input is `true` (default), the qcthat
  ...
  ([\#288](https://github.com/Gilead-BioStats/qcthat/issues/288)).
- [`TriggerUAT()`](https://gilead-biostats.github.io/qcthat/reference/TriggerUAT.md)
  ...
  [`TriggerUAT()`](https://gilead-biostats.github.io/qcthat/reference/TriggerUAT.md)
  is processing
  ([\#299](https://github.com/Gilead-BioStats/qcthat/issues/299)).
- Actions triggered via workflow dispatch now set the branch properly
  ([\#308](https://github.com/Gilead-BioStats/qcthat/issues/308)), and
  action input names match a more standard style
  ([\#310](https://github.com/Gilead-BioStats/qcthat/issues/310)).

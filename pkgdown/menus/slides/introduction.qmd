...
format:
  revealjs:
    ...
    footer: <a href="https://gilead-public.github.io/qcthat/">gilead-public.github.io/qcthat</a>
...
[![github.com/Gilead-Public/qcthat/releases/latest](slide_images/qr_latest_release.png){width=100%}](https://github.com/Gilead-Public/qcthat/releases/latest)
...
::: notes
- We'll talk a bit later about all the reports that are available, including Milestones and UAT which aren't shown in this screenshot.
- The QR code takes you to the latest release. Scroll down to see its attached reports.
- Note the triangle to expand/collapse the reports
:::
...
::: notes
- A lot of you are probably in the process of transitioning to R right now.
- Talk about GitHub, some of its features.
:::
...
::: notes
- Milestone = GitHub option for grouping issues.
:::
...
- We *only* work with GitHub right now, but if you use something else (GitLab, Atlassian, etc) I'd love to work with you to generalize.
...
::: notes
- "Pull request" is weird terminology, but it basically means "proposed changes to the code."
- You can mentally replace "Pull Request" and "PR" with "proposed change".
:::
...
- `{qcthat}` package website: [gilead-public.github.io/qcthat](https://gilead-public.github.io/qcthat)
- Submit issues & discuss at [github.com/Gilead-Public/qcthat](https://github.com/Gilead-Public/qcthat)

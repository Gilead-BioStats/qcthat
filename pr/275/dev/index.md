...
- 🧑‍💻🧪🤖: Where applicable, QCP or PD defines an automated test for
  ...
  [shinytest2](https://rstudio.github.io/shinytest2/) depending on the
  development process. Tests are linked to the corresponding business
  requirements with “(#{issue_number})” in the description.

...
|------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
| `qcthat_UAT`           | Set to `"TRUE"` to make open UAT issues report as test failures. Checked by [`IsCheckingUAT()`](https://gilead-biostats.github.io/qcthat/reference/IsCheckingUAT.md). | `""` (failures are not reported) |

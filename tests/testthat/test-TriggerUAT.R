...
test_that("The UAT workflow triggers properly when all UAT issues connected to a PR are closed (#114)", {
  qcthat::ExpectUserAccepts(
    "The qcthat-uat action triggers report re-run when a single UAT issue is closed",
    intIssue = 114,
